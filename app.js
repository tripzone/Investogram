        ...
        container.innerHTML = `
            <div class="ho-table-wrapper">
                <table class="ho-table">
                    <thead><tr>
                        ${th('Symbol', 'symbol')}
                        ${th('Value', 'currentValueCAD')}
                        ${th('Avg Yrs', 'weightedYears')}
                        ${th('% Port', 'portfolioPct')}
                        ${th('Total P&L', 'totalPnlCAD')}
